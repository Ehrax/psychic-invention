...
% TODO: quelle setzten Quelle: https://de.wikipedia.org/wiki/Quartett_(Kartenspiel)
% TODO: quelle setzten Quelle: https://de.wikipedia.org/wiki/Supertrumpf
...
%TODO: quellenangabe anpassen, 

%QUELLE: https://www.google.de/url?sa=i&rct=j&q=&esrc=s&source=images&cd=&cad=rja&uact=8&ved=0ahUKEwja49HNxK7TAhVENxQKHZLCD8YQjRwIBw&url=http%3A%2F%2Fautogramm.volkswagen.de%2F10_12%2Fautoundtechnik%2Fautoundtechnik_03.html&psig=AFQjCNFkG_BumLaztguoSMh90FYloFPB4g&ust=1492623128576287

%Bin mir außerdem nicht sicher ob wir das Bild verwenden dürfen :D

\begin{figure}[!ht]
\begin{center}
    \includegraphics[scale=0.6]{img/quartett_card.png}
    \caption{Golf GTI Quartettkarte aus einem Autoquartett}
\end{center}

%Außerdem soll das Bild über dem Text sein, vll macht Latex was kaputtt
