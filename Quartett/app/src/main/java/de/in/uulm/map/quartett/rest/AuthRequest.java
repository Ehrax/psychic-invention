 ...
 *
 * This class is used as a base class for all requests that obtain data from the
 * server. These requests require authorization, which is implemented in the
 * getHeaders() method of this class.
 *
...
public abstract class AuthRequest<T> extends Request<T> {
    ...
    /**
     * The base part of the server url.
     */
    public static final String URL = "http://quartett.af-mba.dbis.info";

    /**
     * Server credentials. Cause hardcoding credentials has always been a good
     * idea ...
     */
