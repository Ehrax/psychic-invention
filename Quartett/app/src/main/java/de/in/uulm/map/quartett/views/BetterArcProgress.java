...
/**
 * reworked ArcProgress source: https://github.com/lzyzsd/CircleProgress
 */
public class BetterArcProgress extends View {
    ...
    public BetterArcProgress(Context context, AttributeSet attrs) {

        this(context, attrs, 0);
    }

    public BetterArcProgress(Context context, AttributeSet attrs, int
            defStyleAttr) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        super.onDraw(canvas);
        // arcAngle is the "end"-angle, default: 360 * 0.8
